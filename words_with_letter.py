# Читаем файл со всеми 5 буквенными русскими словами формируем список букв отсортированный по
# количеству слов с буквой
import sys, os
